...
import { Category, Transaction, User, MonthlySummary, TransactionsPagination } from "./type";
...
export const applicationStore = create<Store>((set) => ({                                       
    ...
    setTransactionsPagination: (newPagination) => set({ TransactionsPagination: newPagination }),
    ...
    MonthlySummary: [],
    setMonthlySummary: (newMonthlySummary) => set({ MonthlySummary: newMonthlySummary }),
}));
